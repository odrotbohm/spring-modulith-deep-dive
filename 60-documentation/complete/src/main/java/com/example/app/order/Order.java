...
import com.example.app.customer.Customer;
import com.example.app.customer.Customer.CustomerIdentifier;
import com.example.app.order.Order.LineItem.LineItemId;
import com.example.app.order.Order.OrderIdentifier;
...
public class Order extends AbstractAggregateRoot<Order> implements AggregateRoot<Order, OrderIdentifier> {
	...
	/**
	 * A domain event published, once an {@link Order} has been marked as completed.
	 *
	 * @author Oliver Drotbohm
	 */
